...
<body class="font-sans antialiased bg-[#0F172A] text-white overflow-x-hidden">
    ...
    <nav class="fixed top-0 left-0 right-0 z-50 transition-all duration-300"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="glass rounded-2xl px-4 sm:px-6 py-3 flex items-center justify-between transition-all duration-300"
                 :class="scrolled ? 'shadow-elevation-4' : ''">
                {{-- Logo --}}
                ...
                <div class="flex items-center gap-2">
                    ...
                    {{-- Mobile Menu Button --}}
                    <button @click="mobileOpen = !mobileOpen" class="md:hidden ml-1 p-2 text-white/70 hover:text-white rounded-xl hover:bg-white/5 transition-colors cursor-pointer">
            ...
            <div x-show="mobileOpen" x-cloak
                 ...
                 class="md:hidden mt-2 glass rounded-2xl p-4 space-y-1">
                <a href="#features" @click="mobileOpen = false" class="block px-4 py-3 text-sm font-medium text-white/70 hover:text-white rounded-xl hover:bg-white/5 transition-all cursor-pointer">Features</a>
                <a href="#how-it-works" @click="mobileOpen = false" class="block px-4 py-3 text-sm font-medium text-white/70 hover:text-white rounded-xl hover:bg-white/5 transition-all cursor-pointer">How It Works</a>
                <a href="#security" @click="mobileOpen = false" class="block px-4 py-3 text-sm font-medium text-white/70 hover:text-white rounded-xl hover:bg-white/5 transition-all cursor-pointer">Security</a>
                <a href="#testimonials" @click="mobileOpen = false" class="block px-4 py-3 text-sm font-medium text-white/70 hover:text-white rounded-xl hover:bg-white/5 transition-all cursor-pointer">Reviews</a>
                <div class="border-t border-white/10 my-2"></div>
                <a href="{{ route('login') }}" class="block px-4 py-3 text-sm font-semibold text-white/80 hover:text-white rounded-xl hover:bg-white/5 transition-all cursor-pointer">Log In</a>
            </div>
        </div>
    </nav>
